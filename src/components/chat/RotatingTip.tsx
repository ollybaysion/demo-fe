...
/**
 * 한 줄 가이드 팁 — 같은 자리에서 문구만 바뀐다.
 *
 * 자리를 옮기거나 늘리지 않는 이유: 안내는 배경이지 사건이 아니다. 높이가
 * 들썩이면 아래 버튼이 밀려 "뭔가 일어났나" 싶어진다. 그래서 교체는 짧은
 * 페이드 하나로 끝낸다.
 *
...
export function RotatingTip({
  ...
  return (
    ...
    >
      ...
      <p key={index} className="animate-tip-fade text-caption text-brand-muted">
