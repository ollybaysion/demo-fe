...
**`chat-summary-panel`** — Right 320px panel for ops handover. Section: 요약 (Phase-1 placeholder until backend). `[복사]` flattens it into a single Markdown payload for paste into mail/messenger.
