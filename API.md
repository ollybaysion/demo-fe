...
4. [데이터 모델](#데이터-모델) — Message / Table / Chart / Timeline / Attachment / Context
5. [에러 형식](#에러-형식)
6. [보안 / 운영 정책](#보안--운영-정책)

정형 조회 GET 은 없다. 설비·챔버·센서를 포함한 모든 데이터는 채팅 응답의
`dataRequests`(요청 카드)로 요구하고, 사용자가 결과를 붙여넣어 공급한다.
